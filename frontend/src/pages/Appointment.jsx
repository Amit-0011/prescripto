...
// // this is the debuged code start
//   const bookAppointment = async () => {
//   if (!token) {
//     toast.warn('Login to book appointment')
//     return navigate('/login')
...
//   // Validate that docSlot data exists
//   if (!docSlot || docSlot.length === 0 || !docSlot[slotIndex] || docSlot[slotIndex].length === 0) {
//     toast.error('No available slots. Please try again.')
//     return
//   }

//   try {
//     // Find the specific time slot that was selected
//     const selectedTimeSlot = docSlot[slotIndex].find(slot => slot.time === slotTime)
...
//     const date = selectedTimeSlot.datetime
